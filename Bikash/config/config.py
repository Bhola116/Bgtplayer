...
API_ID = int(getenv("26312944"))
API_HASH = getenv("43ed21a9affbdcb3fb9a96b6cef9e3a0")
BOT_ID = int(getenv("BOT_ID", ""))
BOT_TOKEN = getenv("6848043141:AAFYfT-NAEYs8oGMcFR02qO-XbZ2Or8fScA")
COMMAND_PREFIXES = list(getenv("COMMAND_PREFIXES", "/ ! .").split())
MONGO_DB_URI = getenv("MONGO_DB_URI", None)
LOG_GROUP_ID = int(getenv("-1001521877601"))
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "༺team shadow bot ༻")
OWNER_ID = list(map(int, getenv("OWNER_ID", "7109918450").split()))
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/Team_Shadow_Group")
